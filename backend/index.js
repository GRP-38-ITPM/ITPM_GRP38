...
server.post('/addgarbages',(req,res)=>{
    logic.addGarbages(req.body.id,req.body.gbid,req.body.gbname,req.body.quantity,req.body.description).then(
        (result)=>{
            res.status(result.statusCode).json(result)
        }
...
server.post('/editgarbages',(req,res)=>{
    logic.editGarbages(req.body.id,req.body.gbid,req.body.gbname,req.body.quantity,req.body.description).then(
        (result)=>{
            res.status(result.statusCode).json(result)
        }
